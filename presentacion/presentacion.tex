 ...
 for (int j=i+1; j<n; ++j)
  if (instance->isValidEdge(i,j))
   if (!chromosome[i]&&!chromosome[j])
    ...
    {\footnotesize Estaciones en el anillo $[\alpha R,\,R]$ alrededor del nodo $j$ deben cubrir su demanda $D_j$.}
...
\begin{frame}{Conclusiones y Trabajo Futuro}
  \begin{columns}[T]
    ...
    \begin{itemize}\footnotesize
      ...
      \item[\acento{\checkmark}] R2 con anillo $V_j^{\alpha R}=[\alpha R,\,R]$ fiel al paper
    \end{itemize}
